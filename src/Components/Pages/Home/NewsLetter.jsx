            ...
            <Fade bottom>
              <div className="mt-10 flex justify-center">
                <form className="flex divide-x">
                  <input
                    className="shadow appearance-none border-none rounded-l-lg w-52 lg:w-96 py-4 px-3 text-gray-700 leading-tight focus:outline-none focus-0 focus:shadow-outline"
                    id="username"
                    type="email"
